...
def can_traverse(nums: List[int]) -> bool :
    ...
    while (max_traversable_distance < len(nums)-1) and index <= max_traversable_distance:
...
def get_user_input():
    while True:
        ...
        try:
            ...
            print(f"Invalid input. Please ensure you enter integers separated by spaces.\nError: {e}")
