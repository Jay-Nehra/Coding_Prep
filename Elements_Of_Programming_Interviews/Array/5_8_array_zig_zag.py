...
def main():
    ...
    arr = user_input()
    zigzag = arrange(arr)
    logger.info(f"Resulting list of numbers in the requested zigzag pattern is  with sorted inout : \n {zigzag}")
    
    zigzag_ls = arrange_local_swap(arr)
    logger.info(f"Resulting list of numbers in the requested zigzag pattern is  without sorting the input first : \n {zigzag_ls}")
