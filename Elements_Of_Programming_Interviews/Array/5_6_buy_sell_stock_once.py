...
def user_input() -> List[int]:
    while True:
        user_input = input("Please enter the space seperated integer array representing the prices for the stock over the given period. eg '1 2 3'. \n")
        try:
...
def main():
    ...
    logger.info(f"Here is the maximum profit for the stock over the given range:   {max_profit}")
